     ...
     while($arr=mysqli_fetch_array($result))
        {
          if($x==0) 
            echo "<div class='row'>";
                ...
                echo "<a href='mobile_spc.php?p_id=$arr[0]'>";
                echo "<div align='center' style='box-shadow:0 3px 6px 0 #d9b6db; border-radius:5px;'>";
                echo "<img  src=$arr[4] width='200px' height='410px' ></img>";
